    ...
    private void initializeTheme() {
      switch (selectedTheme) {
        case R.style.AppTheme_Blue:
          ...
          unselectedMarkerIcon = IconFactory.getInstance(context).fromResource(R.drawable.stairs);
          selectedMarkerIcon = IconFactory.getInstance(context).fromResource(R.drawable.stairs);
